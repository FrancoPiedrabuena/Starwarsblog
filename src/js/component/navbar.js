...
export const Navbar = (item, resource) => {
	...
	return (
		<nav className="navbar  background-color: transparent ! important;">
			<div className="Logo">
				<Link to="/">
					<img className="Img"  src="https://1000marcas.net/wp-content/uploads/2019/12/Star-Wars-emblema.jpg"/>
				</Link>
			</div>
			<div>
